...
var _arweave = node_1.default.init({ host: 'arweave.net', port: '443', protocol: 'https' });
var wallet0 = JSON.parse(fs_1.readFileSync(__dirname + '/test_key0.json').toString());
var wallet1 = JSON.parse(fs_1.readFileSync(__dirname + '/test_key1.json').toString());
var TEST_STRING = 'HELLOWORLD_TEST_STRING';
var TEST_TAGS = [{ name: 'MyTag', value: '0' }, { name: "OtherTag", value: "Foo" }, { name: "MyTag", value: '1' }];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        item = _b.sent();
                        chai_1.expect(item.data).to.not.equal(TEST_STRING);
                        _a = chai_1.expect;
                        return [4 /*yield*/, Data.decodeData(item, { string: true })];
                    case 2:
                        _a.apply(void 0, [_b.sent()]).to.equal(TEST_STRING);
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        verified = _a.sent();
                        chai_1.expect(verified).to.equal(true);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Data.verify(signed)];
                    case 3:
                        _a.apply(void 0, [_j.sent()]).to.equal(false);
                        signed.id = "FOO";
                        _b = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 4:
                        _b.apply(void 0, [_j.sent()]).to.equal(false);
                        signed.id = INVALID_BASE64U;
                        _c = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 5:
                        _c.apply(void 0, [_j.sent()]).to.equal(false);
                        signed.id = correctId;
                        _d = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 6:
                        _d.apply(void 0, [_j.sent()]).to.equal(true);
                        return [4 /*yield*/, Data.sign(item0, wallet0)];
                    case 7:
                        signed2 = _j.sent();
                        ...
                        return [4 /*yield*/, Data.verify(signed)];
                    case 8:
                        _e.apply(void 0, [_j.sent()]).to.equal(false);
                        signed2.signature = VALID_BASE64U;
                        _f = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 9:
                        _f.apply(void 0, [_j.sent()]).to.equal(false);
                        signed2.signature = INVALID_BASE64U;
                        _g = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 10:
                        _g.apply(void 0, [_j.sent()]).to.equal(false);
                        signed2.signature = correctSignature;
                        _h = chai_1.expect;
                        return [4 /*yield*/, Data.verify(signed)];
                    case 11:
                        _h.apply(void 0, [_j.sent()]).to.equal(true);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 7:
                            bundle = _a.sent();
                            chai_1.expect(bundle.items).to.be.an.instanceOf(Array);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should unbundle a number of items', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            json = fs_1.readFileSync(__dirname + '/bundle0.json').toString();
                            return [4 /*yield*/, Data.unbundleData(json)];
                        case 1:
                            items = _a.sent();
                            chai_1.expect(items.length).to.equal(3);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should unbundle and discard invalid items', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            json = fs_1.readFileSync(__dirname + '/bundle1-invaliditem0.json').toString();
                            return [4 /*yield*/, Data.unbundleData(json)];
                        case 1:
                            items = _a.sent();
                            chai_1.expect(items.length).to.equal(2);
                            return [2 /*return*/];
                    }
                });
            });
